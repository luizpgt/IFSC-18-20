...
@section('content')
    ...
    <section class="jumbotron text-center pb-5 pt-5 card text-white bg-info mb-5 mt-4">
        <div class="container pt-4">
            ...
            <p class="jumbotron-heading">Editar PALAVRA</p>
        </div>
    </section>
    ...
    <section id="sugestao" class="pb-5">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center ">
                <div class=" col-sm-10">
                    <form action="{{ action('PalavraController@update')}}" method="POST">
                        @csrf
                    <input type="hidden" id="id" name="id" value="{{$palavra->id}}">
                        ...
                        <input type="text" name="palavra" value="{{$palavra->palavra}}" class="form-control" placeholder="palavra" aria-label="Busque por alguma sugestão já adicionada!" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">public\imagens\palavras\</span>
                            </div>
                        <input type="text" name="imagem" value="{{$palavra->imagem}}" class="form-control" placeholder="Não esqueça de fazer upload das imagens na pasta!" aria-label="Busque por alguma sugestão já adicionada!" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
