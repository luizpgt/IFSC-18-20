...
@section('content')
    ...
    <section class="jumbotron text-center pb-5 pt-5 card text-white bg-info mb-5 mt-4">
        <div class="container pt-4">
            ...
            <p class="jumbotron-heading">Editar CONTEXTO</p>
        </div>
    </section>
    ...
    <section id="sugestao" class="pb-5">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center ">
                <div class=" col-sm-10">
                    <form action="{{ action('ContextoController@update')}}" method="POST">
                        @csrf
                    <input type="hidden" id="id" name="id" value="{{$contexto->id}}">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">Contexto</span>
                            </div>
                        <input type="text" name="contexto" value="{{$contexto->contexto}}" class="form-control" placeholder="contexto" aria-label="Busque por alguma sugestão já adicionada!" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
